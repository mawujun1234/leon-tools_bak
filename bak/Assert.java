 ...
 * 
 * <pre class="code">
 * Assert.hasText(uName, new IllegalBizArgumentsException(ErrorCode.USERNAME_ERROR));
 * </pre>
 * 
 * @author badqiu
 * @author calvin
...
//	}
	...
	/**
	 * Assert a boolean expression, throwing <code>BizException</code>
	 ...
	 * @throws BizException if expression is <code>false</code>
	 */
	 ...
	 * @throws BizException if the object is not <code>null</code>
	 */
	 ...
	 * @param object  the object to check
	 * @param message the exception message to use if the assertion fails
	 * @throws BizException if the object is <code>null</code>
	 */
	 ...
	 * @throws BizException if the object array is <code>null</code> or
	 *                                  has no elements
	 */
	 ...
	 * @param array   the array to check
	 * @param message the exception message to use if the assertion fails
	 * @throws BizException if the object array contains a
	 ...
	 * @param message    the exception message to use if the assertion fails
	 * @throws BizException if the collection is <code>null</code> or
	 *                                  has no elements
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws BizException if the map is <code>null</code> or has no
	 *                                  entries
	 */
